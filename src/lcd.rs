...
make_crh_func!(d7_mode_bits, mode15);
make_crh_func!(d7_cnf_bits, cnf15);
make_bsrr_func!(d7_bsrr_set, bs15);
make_brr_func!(d7_brr_set, br15);
make_idr_func!(d7_idr_get, idr15);

make_crl_func!(d6_mode_bits, mode5);
make_crl_func!(d6_cnf_bits, cnf5);
make_bsrr_func!(d6_bsrr_set, bs5);
make_brr_func!(d6_brr_set, br5);
make_idr_func!(d6_idr_get, idr5);

make_crl_func!(d5_mode_bits, mode4);
make_crl_func!(d5_cnf_bits, cnf4);
make_bsrr_func!(d5_bsrr_set, bs4);
make_brr_func!(d5_brr_set, br4);
make_idr_func!(d5_idr_get, idr4);

make_crl_func!(d4_mode_bits, mode3);
make_crl_func!(d4_cnf_bits, cnf3);
make_bsrr_func!(d4_bsrr_set, bs3);
make_brr_func!(d4_brr_set, br3);
make_idr_func!(d4_idr_get, idr3);
...
pub struct LCD1602 {
    ...
    gpiob: &'static gpioa::RegisterBlock,
    afio: &'static afio::RegisterBlock
}

unsafe impl Sync for LCD1602 {}
unsafe impl Send for LCD1602 {}
...
impl LCD1602 {
    ...
    pub fn init(&self, disp_attr: u8) {
        let gpioa = &self.gpioa;
        let gpiob = &self.gpiob;
        self.afio.mapr.write(|w| unsafe {w.swj_cfg().bits(0b010)});
        ...
        gpiob.bsrr.write(|w| d5_bsrr_set(w)); // function set
        gpiob.bsrr.write(|w| d4_bsrr_set(w)); // 8-bit mode
        ...
        gpiob.bsrr.write(|w| d5_bsrr_set(w)); // function set
        gpiob.brr.write(|w| d4_brr_set(w)); // 4-bit mode
        self.toggle_en();
